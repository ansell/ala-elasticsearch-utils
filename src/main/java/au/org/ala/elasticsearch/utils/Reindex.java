    ...
    public static void main(String[] args) throws Exception {
        ...
        final OptionSpec<String> sourceOption = parser.accepts("source").withRequiredArg()
                .ofType(String.class).required().describedAs(
                        "The elasticsearch index to use as the source for the reindex");
        final OptionSpec<String> destinationOption = parser.accepts("destination").withRequiredArg()
                .ofType(String.class).required().describedAs(
                        "The elasticsearch index to use as the destination for the reindex");
...
//        final String destinationIndex = "example-filebeat-www-2020.11.18";
        ...
        try (RestHighLevelClient client = new RestHighLevelClient(
            ...
            String taskId = AlaElasticsearchUtils.asyncReindex(client, sourceIndex, destinationIndex);
